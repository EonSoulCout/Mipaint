    ...
    , ui(new Ui::Principal)
{
    ...
    mForma = Forma::LIBRE;
    elegirForma();
    connect(ui->actionLimpiar, &QAction::triggered, this, &Principal::on_actionLimpiar_triggered);
}
...
void Principal::on_actionLimpiar_triggered()
{
    ...
    // Establecer el color de fondo para "borrar" la pantalla
    mPainter->eraseRect(rect);
